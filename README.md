...
3. Select a model to train (it can be any spaCy model compatible with spaCy 2.2+) or create a blank model. Labels in the training data should match labels in the original model otherwise start from blank model.<br/>
