...
2. Select `train` and `dev` data files in spaCy format. You can use [**TagEditor**](https://github.com/d5555/TagEditor) to create your training dataset. For demonstration purposes there are 2 dataset files, IMDB_train.spacy and IMDB_dev.spacy annotated with POS ,Dependencies, NER and Textcategories.
